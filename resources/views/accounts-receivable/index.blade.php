...
@section('content')
<x-page-header title="Cuentas por cobrar" subtitle="Saldo pendiente agrupado por antigüedad" :back="route('dashboard')">
    <x-slot:actions>
        <a href="{{ route('accounts-receivable.export', ['as_of' => $asOf]) }}"
           class="btn btn-outline px-4 py-2 text-sm font-semibold rounded-lg">
...
@php
    $buckets = [
        'current' => ['label' => 'Al día', 'color' => 'emerald', 'icon' => 'check'],
