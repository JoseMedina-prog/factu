...
<x-form-layout
    ...
    footer-hint="Deja la contraseña vacía si no quieres cambiarla"
    :tips="[
        'Edita el <strong>nombre</strong> o <strong>correo</strong> del usuario.',
        'Solo cambia la <strong>contraseña</strong> si es necesario.',
        'El <strong>rol</strong> define qué puede hacer en el sistema.',
...
>
    <div class="field-primary">
        ...
        <div class="input-modern input-modern-lg">
            ...
            <input type="text" id="field-name" name="name" value="{{ old('name', $user->name) }}" required autocomplete="name" class="input-modern-field">
        </div>
        @error('name')
    ...
    <div class="field-group">
        ...
        <div class="input-modern">
            ...
            <input type="email" id="field-email" name="email" value="{{ old('email', $user->email) }}" required autocomplete="email" class="input-modern-field">
        </div>
        @error('email')
            <p class="field-error">{{ $message }}</p>
        @enderror
    ...
    <div class="field-grid-2">
        <div class="field-group">
            <label for="field-password" class="field-label">Nueva contraseña</label>
            <div class="input-modern" x-data="{ show: false }">
                ...
                <input :type="show ? 'text' : 'password'" id="field-password" name="password" placeholder="Dejar vacío para no cambiar" class="input-modern-field pr-12">
        ...
        <div class="field-group">
            <label for="field-password-confirmation" class="field-label">Confirmar contraseña</label>
            <div class="input-modern">
                <span class="input-modern-icon">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <input type="password" id="field-password-confirmation" name="password_confirmation" placeholder="Repite la contraseña" class="input-modern-field">
            </div>
        </div>
    </div>
    ...
    <div class="field-group">
        ...
        <div class="grid sm:grid-cols-2 gap-3">
            ...
            <label class="role-card">
                <input type="radio" name="role" value="staff" {{ $user->role == 'staff' ? 'checked' : '' }} class="sr-only peer">
                <div class="role-card-content">
